...
appConfig.skins = [
    {name: "smart-style-0",
        logo: "styles/img/TopLogo.png",
        class: "btn btn-block btn-xs txt-color-white margin-right-5",
        style: "background-color:#4E463F;",
        label: "Smart Default"},

    {name: "smart-style-1",
        logo: "styles/img/TopLogoWhite.png",
...
if (appConfig.voice_command) {
     	...
     	'show dashboard': function () { window.location.hash = "cp-export-import" },
        ...
        'show import': function () { window.location.hash = "import" },
        'show export': function () { window.location.hash = "export" },
        'show outstanding': function () { window.location.hash = "outstanding" },
        'show payment': function () { window.location.hash = "recent-payment" },
        'show home': function () { window.location.hash = "cp-service-notification" },
        'show my books': function () { window.location.hash = "cp-mybooks" },
        'show my documents': function () { window.location.hash = "cp-mydocument" },
        'show recent payment': function () { window.location.hash = "recent-payment" },
        'show event configuration' : function() { window.location.hash = "event-configuration" },
...
angular.module('app', [
    ...
    //CHANGES : newly defined modules for 'iLogis Customer Portal'
    'app.import',
    'app.export',
    'app.outstanding',
    'app.recent-payment',
...
.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        .state('app', {
            ...
            views: {
                root: {
                    templateUrl: 'app/layout/cp-layout.tpl.html'
                }
            }
        });
    $urlRouterProvider.otherwise('/cp-service-notification');
...
'use strict';
angular.module('app.dashboard')
    .controller('DashboardCtrl', function ($scope, $interval, CalendarEvent) {
...
angular.module('app.auth')
    .controller('LoginCtrl', function ($scope, $state, GooglePlus, User, ezfb) {
...
"use strict";
angular.module('app')
    .directive('activitiesDropdownToggle', function ($log) {
...
angular.module('app')
    .factory('Project', function ($http, APP_CONFIG) {
    return {
...
angular.module('app.inbox')
    .directive('messageLabels', function (InboxConfig) {
    return {
        replace: true,
        restrict: 'AE',
        link: function (scope, element) {
...
angular.module('app')
    .factory('Language', function ($http, APP_CONFIG) {
...
angular.module('app.maps')
    .factory('SmartMapStyle', function ($q, $http, APP_CONFIG) {
    ...
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            if(attributes.bindFilters){
                element.parent().find("div.toolbar").html('<div class="text-right"><img src="styles/img/logo.gif" alt="iLogisCustomerPortal" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
...
angular.module('app.tables').directive('datatableColumnFilter', function () {
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            // custom toolbar
            element.parent().find("div.toolbar").html('<div class="text-right"><img src="styles/img/TopLogo.png" alt="iLogisCustomerPortal" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
